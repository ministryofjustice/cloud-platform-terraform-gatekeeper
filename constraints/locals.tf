locals {
  ...
  deny_kubectl_create_sa                  = yamldecode(file("${path.module}/../resources/constraints/deny_sa.yaml"))
  ...
  constraint_map = {
    ...
    deny_kubectl_create_sa             = merge(local.deny_kubectl_create_sa, { "spec" : merge(local.deny_kubectl_create_sa["spec"], { "enforcementAction" : var.dryrun_map.deny_kubectl_create_sa ? "dryrun" : "deny" }) })
  }
}
